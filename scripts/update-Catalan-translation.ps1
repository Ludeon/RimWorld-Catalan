<#
	.SYNOPSIS
	This script installs or updates latest localization files for RimWorld in the Catalan official repository.
	.DESCRIPTION
	This script installs or updates the latest available localization files in Catalan downloaded from the official repository. Also downloads and installs the translation files for the available DLCs.

	Originally developed by Xeros08 (Aser Granado Amores).

	.FUNCTIONALITY
	To use this script, move it to the root folder of the game, next to the executable file of the game, the folder "Mods" and the folder "Data".
#>
...
# Variables to use
$repo_owner = "Ludeon"
$official_repo = "RimWorld-Catalan"
$branch = "master"

$ingame_name = "Catalan (Català)"
